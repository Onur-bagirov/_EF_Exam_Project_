...
namespace _EF_Exam_Project_.context
{
    public class BookShopDataBase : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=WINDOWS_11_ONUR\\MSSQLSERVER01;Initial Catalog=LastTest1;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;");
